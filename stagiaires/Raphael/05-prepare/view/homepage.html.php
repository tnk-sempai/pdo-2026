...
<body>
    <div class="container">
        ...
        <main>
            <?php
            // on a tenté d'envoyé le formulair et
            // il a passé les proctections frontend
            if(isset($insert)):
                ...
                <div class="insert-message">
                    Merci pour votre message vous aller être redirigé
                    <script>setTimeout(
                        function(){
            ...
            <section class="form-section">
                <form id="guestbook-form" method="POST">
                    <div class="form-group">
                        ...
                        <input type="text" id="email_message" name="email_message" placeholder="Ex: JeanDupont@cf2m.be">
                    </div>
            ...
            <section class="messages-section">
                ...
                <div class="message-card">
                    <!-- Les messages apparaîtront ici -->
                     <h3>Écris par <?= htmlspecialchars($message['email_message'])?> le <?= $message['date_message']?></h3>
